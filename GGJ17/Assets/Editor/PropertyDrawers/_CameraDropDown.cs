...
[CustomPropertyDrawer(typeof(CameraDropDownAttribute))]
public class _CameraDropDownAttribute : PropertyDrawer {
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
		...
		if (property.propertyType == SerializedPropertyType.ObjectReference) {
			...
			property.objectReferenceValue = DrawCameraPopup(position, label, property.objectReferenceValue as Camera, (attribute as CameraDropDownAttribute).fullHierarchy);
